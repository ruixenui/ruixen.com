    ...
    <section>
      ...
      <div className="flex justify-center items-center mx-auto bg-white dark:bg-black text-black dark:text-white transition-all duration-300">
        <div className="relative min-h-screen bg-white dark:bg-black">
          ...
          {/* Main Content */}
          <div className="relative z-10 text-left mx-auto container flex flex-col md:flex-row gap-10 items-center">
            <div className="flex-1">
              <AnimatedGroup variants={transitionVariants} className="mt-40">
                <h1 className="relative text-[3.5rem] sm:text-[5rem] md:text-[6rem] xl:text-[7.5rem] font-semibold leading-[1.1]">
