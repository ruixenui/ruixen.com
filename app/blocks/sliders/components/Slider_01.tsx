...
import { cn } from '@/lib/utils'; // Replace with your local utils or remove if unused

export const codeStringSlider_01 = `'use client';
...
export default function Slider_01() {
  ...
  return (
    <div className="w-full h-full relative px-6 py-12 overflow-hidden">
