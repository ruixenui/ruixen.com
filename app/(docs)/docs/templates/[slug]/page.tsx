...
async function resolveTemplate(
  ...
  try {
    ...
    // Fall through to the static snapshot when the Pro API is unreachable.
  }

  const snapshotTemplate = PRO_TEMPLATES_SNAPSHOT.items.find(
    (t) => t.slug === slug && t.is_active,
  );
  if (snapshotTemplate) return { kind: "pro", template: snapshotTemplate };
