...
export const codeStringClientLabel_02 = `"use client";
...
export default function ClientLabel_02() {
        ...
        <div className="w-full py-20 lg:py-40">
            <div className="container mx-auto">
                <div className="flex flex-col gap-10">
                    ...
                    Empowering<br /> global teams to innovate with{" "}
                    ...
                    <Carousel setApi={setApi} className="w-full">
                        <CarouselContent>
                            {logos.map((logo, index) => (
                                <CarouselItem className="relative basis-1/4 lg:basis-1/6 border border-dashed border-zinc-400 dark:border-zinc-700 p-2 m-2" key={index}>
                                    ...
                                    <div className="flex items-center justify-center h-40 w-42 bg-muted border border-gray-200">
                                        <Link href={logo.href} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
                                            <Image
                                                src={logo.src}
                                                alt={logo.alt}
                                                width={logo.width}
