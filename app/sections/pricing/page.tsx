...
import { pricingComponents } from './PricingComponentsExport';
...
export default function Page() {
  ...
  return (
    <div className="dark:bg-black bg-white w-full min-h-screen flex flex-col items-start p-2 pt-24">
      <HeadingSpotlight title="Pricing" />
      ...
      {openIndex !== null && (
        <div ref={showcaseRef} className="w-full mt-12">
          <TemplateShowcasePage
            title={pricingComponents[openIndex].name}
            description={pricingComponents[openIndex].description}
            preview={pricingComponents[openIndex].preview}
            code={pricingComponents[openIndex].code}
          />
        </div>
      )}
    </div>
