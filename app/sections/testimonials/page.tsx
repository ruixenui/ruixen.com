...
import { testimonialComponents } from './TestimonialComponentsExport';
      ...
      {openIndex !== null && (
        <div ref={showcaseRef} className="w-full mt-12">
          <TemplateShowcasePage
            title={testimonialComponents[openIndex].name}
            description={testimonialComponents[openIndex].description}
            preview={testimonialComponents[openIndex].preview}
            code={testimonialComponents[openIndex].code}
          />
        </div>
      )}
    </div>
