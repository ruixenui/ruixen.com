...
export const codeStringFooter_02 = `"use client";
...
export default function Footer_02() {
  const socialIcons = [
    ...
    },
    {
      ...
      icon: "https://upload.wikimedia.org/wikipedia/commons/a/a5/Instagram_icon.png", // PNG
    }  
  ];
  ...
  return (
    <footer className="bg-background text-foreground border-t pt-20 pb-10 px-4">
      <div className="max-w-6xl mx-auto grid gap-12 lg:grid-cols-5">
        ...
        <div className="col-span-2 space-y-6 text-sm">
          <Link href="/" className="flex items-center gap-3">
            ...
            />
            <span className="text-2xl font-bold tracking-tight">Ruixen Premium</span>
          </Link>
          <p className="text-muted-foreground leading-relaxed">
            Unlock beautifully crafted UI components and lifetime updates. Designed for product builders, startups, and UI engineers.
          </p>
        ...
        <div className="col-span-3 grid grid-cols-2 md:grid-cols-3 gap-6 text-sm">
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li><Link href="/components/buttons" className="hover:text-primary">Buttons</Link></li>
              <li><Link href="/components/cards" className="hover:text-primary">Cards</Link></li>
              <li><Link href="/components/footers" className="hover:text-primary">Footers</Link></li>
              <li><Link href="/components/heroes" className="hover:text-primary">Hero Sections</Link></li>
              <li><Link href="/components/ctas" className="hover:text-primary">CTAs</Link></li>
            </ul>
          </div>
          <div>
      ...
      <div className="mt-16 border-t pt-6 text-xs text-muted-foreground text-center space-y-1">
        ...
        <p>
          Built with <span className="text-primary font-medium">Shadcn UI</span> and hosted on <span className="font-medium">cloudflare</span>.
        </p>
      </div>
    </footer>
  );
