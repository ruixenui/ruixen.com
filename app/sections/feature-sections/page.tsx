...
import { featuredComponents } from './FeaturedComponentsExport';
...
export default function Page() {
  ...
  return (
    <div className="dark:bg-black bg-white w-full min-h-screen flex flex-col items-start p-2 pt-24">
      ...
      <HeadingSpotlight title="Feature Sections" />
      ...
      {openIndex !== null && (
        <div ref={showcaseRef} className="w-full mt-12">
          <TemplateShowcasePage
            title={featuredComponents[openIndex].name}
            description={featuredComponents[openIndex].description}
            preview={featuredComponents[openIndex].preview}
            code={featuredComponents[openIndex].code}
          />
        </div>
      )}
    </div>
