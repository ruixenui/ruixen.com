...
import { Card, CardContent } from "@/components/ui/grid-card";

export const codeStringFeatured_02 = `"use client";
  ...
  return (
    <section className="max-w-5xl mx-auto relative py-16 px-4 md:px-8 lg:px-16 bg-white dark:bg-black text-gray-800 dark:text-gray-100 overflow-hidden">
      <div className="mx-auto text-center mb-12 z-10">
        <h2 className="text-3xl md:text-4xl font-bold">Key Platform Features</h2>
        <p className="mt-4 text-gray-600 dark:text-gray-400 max-w-xl mx-auto">
          Explore how our platform supports your business growth and customer satisfaction.
        </p>
      </div>
