...
interface Featured01Props {
  features?: FeatureItem[];
  heading?: string;
}

export const codeStringFeatured_01 = `"use client";
...
export default function Featured_01({
            ...
            {features.map((feature) => {
              ...
              return (
                <li
                  ...
                  className={\`group flex items-start gap-3 p-3 border-b border-gray-300 dark:border-gray-700 cursor-pointer transition-all duration-300 transform rounded-lg \${isActive
                ...
                >
                  ...
                  <div>
                    <h3
                      className={\`text-md font-semibold mb-1 transition-colors \${isActive
                        ? "text-primary"
            ...
            {features.map((feature) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {isActive && <div className="w-5 h-5">
                      <Atom
                        className="w-full h-full"
                        style={{
                          stroke: "url(#grad)",
