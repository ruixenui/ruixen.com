...
export default function Page() {
  ...
  return (
    <div className="dark:bg-black bg-white w-full min-h-screen flex flex-col items-start p-2 pt-24">
      ...
      <SnippetSidebar
        open={openIndex !== null}
        title={openIndex !== null ? heroComponents[openIndex].name : ''}
        installCommand={heroComponents[openIndex!]?.installCommand}
        activeTab={activeTab}
