...
type Button07Props = React.ButtonHTMLAttributes<HTMLButtonElement>;

export const codeStringButton_07 = `"use client";
...
export default function Button_07({ ...rest }: Button07Props) {
    return (
