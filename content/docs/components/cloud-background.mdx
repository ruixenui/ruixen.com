...
date: 2024-06-01
description: React animated background — a flowing cloud background with WebGL shaders and theme support.
author: ruixen
published: true
---

<ComponentPreview name="cloud-background-demo" category="backgrounds" />
...
<ComponentSource name="cloud-background" />
