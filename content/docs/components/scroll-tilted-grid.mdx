...
date: 2026-05-01
description: React carousel component — an editorial two-column image grid where pairs of stills rise from below tipped forward, settle into focus, then tilt away over.
author: ruixen
published: true
---
