...
date: 2026-04-09
description: React animated text — a scroll-driven text reveal — each word fades up from below as you scroll, with staggered opacity and y-translate transforms powered by.
author: ruixen
published: true
---
