...
title: Scramble Text
date: 2025-05-01
description: React animated text — Hover triggers a decode sequence — characters dissolve into random glyphs then resolve in a directional wave that follows your entry.
author: ruixen
published: true
---
