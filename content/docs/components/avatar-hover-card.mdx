...
date: 2025-05-01
description: React avatar component — an interactive avatar that reveals a profile card on hover with spring physics, staggered content, and delayed open/close for.
author: ruixen
published: true
---
