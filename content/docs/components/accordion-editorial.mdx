...
date: 2025-05-01
description: React accordion component — a pull-quote-accented accordion with sentence-length titles, hover micro-translation, and opacity-driven hierarchy for editorial.
author: ruixen
published: true
---
