...
date: 2024-06-01
description: React tabs component — Reorderable tabs with spring physics on drop, staggered cascade, velocity-aware snap, and audio tick on drag, reorder, and drop.
author: ruixen
published: true
---
