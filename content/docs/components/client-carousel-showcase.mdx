...
date: 2024-08-24
description: Shadcn client logos section — Proximity ribbon marquee — logos drift continuously, pause on hover, and respond to cursor proximity with a smoothstep gaussian.
author: ruixen
published: true
---
