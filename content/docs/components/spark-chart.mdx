...
title: Spark Chart
date: 2026-02-07
description: React chart component — an interactive sparkline with path-following indicator, dual-path color reveal, and draw-in animation. Inspired by Rauno Freiberg's.
author: ruixen
published: true
---
