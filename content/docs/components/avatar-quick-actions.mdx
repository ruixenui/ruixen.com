...
date: 2025-05-01
description: React avatar component — an orbital action ring that blooms outward from the avatar with staggered spring emergence — hover any action and the rest dim.
author: ruixen
published: true
---
