...
date: 2025-05-01
description: React avatar component — an overlapping avatar stack with Magnetic Repulsion — hover any avatar and neighbors spring away proportionally to 1/distance.
author: ruixen
published: true
---
