...
date: 2024-11-01
description: Shadcn hero section — a clean hero section with announcement pill, overlapping showcase cards, trusted-by logo strip, and dual CTAs.
author: ruixen
published: true
---
...
export default function App() {
  return (
    <StructuredHeroSection
      announcement="240+ Components and Counting"
