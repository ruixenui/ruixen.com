...
<ComponentPreview name="heatmap-calendar-demo" category="calendars" />
...
```bash
npx shadcn@latest add "https://ruixen.com/r/heatmap-calendar"
```
...
<ComponentSource name="heatmap-calendar" />
