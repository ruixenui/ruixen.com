...
date: 2024-06-01
description: Shadcn FAQ section — a responsive FAQ component with animated text reveals and customizable content.
author: ruixen
published: true
---

<ComponentPreview name="staggered-faq-section-demo" />
...
<ComponentSource name="staggered-faq-section" />
...
| ----------------- | ----------- | -------------------------------------------------------- | ----------------------------------------- |
| `title`           | `string`    | `"StaggeredFAQSection"`                                  | The main heading text                     |
| `subtitle`        | `string`    | `"Everything you need to know about Ruixen UI"`          | The subtitle text below the heading       |
