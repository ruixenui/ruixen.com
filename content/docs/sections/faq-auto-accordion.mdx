...
date: 2024-06-01
description: Shadcn FAQ section — Spring-driven FAQ with a traveling accent bar, spring height animation, blur-deblur text reveal, and layout FLIP repositioning.
author: ruixen
published: true
---
