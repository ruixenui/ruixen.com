...
image: https://pub-940ccf6255b54fa799a9b01050e6c227.r2.dev/gradients/shade_shifters/shade-shifters-11.png
...
export function Accordion({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <details className="group rounded-lg border p-3 open:shadow-sm">
      ...
      <div className="mt-2 overflow-hidden will-change-transform
...
export function Toasts({ items }: { items: Array<{ id: string; text: string }> }) {
  return (
