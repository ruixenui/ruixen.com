...
>
  ...
  <ul className="flex flex-wrap gap-3">
    <li><a href="#tldr-the-short-recommendation">TL;DR</a></li>
    <li><a href="#what-makes-a-great-nextjs-ui-library-in-2025">What makes a great library</a></li>
    <li><a href="#top-nextjs-ui-libraries">Top libraries</a></li>
    <li><a href="#best-nextjs-templates-starters">Templates & starters</a></li>
    <li><a href="#choosing-a-primary-ui-library">Choosing a primary UI library</a></li>
    <li><a href="#how-to-pick-the-right-library-for-your-nextjs-project">How to pick</a></li>
    <li><a href="#setup-starter-guide">Setup guide</a></li>
    <li><a href="#pricing-licensing-community">Pricing & community</a></li>
    <li><a href="#harsh-truths-nextjs-ui-stacks">Harsh truths</a></li>
    <li><a href="#faq">FAQ</a></li>
    <li><a href="#final-recommendation-1-click-freebies">Final recommendation</a></li>
    <li><a href="#references-further-reading">References</a></li>
  </ul>
</nav>
...
>
  <caption className="mb-2 text-left text-xs text-muted-foreground">
    High-level comparison of popular Next.js–ready UI libraries and templates in 2025.
  </caption>
  <thead>
    <tr>
    ...
    <section className="mx-auto mt-10 max-w-4xl px-4">
      ...
      <Card>
        ...
        <CardContent className="text-sm text-muted-foreground">
          Use shadcn/ui for primitives, a Tailwind kit for sections, and
          wire everything up to your own data model and auth.
        </CardContent>
        <CardFooter>
...
export const metadata: Metadata = {
  ...
  description: "Next.js 15 SaaS starter using Tailwind and shadcn/ui components.",
};
    ...
    <main className="mx-auto max-w-5xl px-4 py-12">
      ...
      <section className="grid gap-6 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent className="text-xs text-muted-foreground">
            Own your component code so you can evolve your design system over time.
          </CardContent>
          <CardFooter>
            <Button size="sm" variant="outline">
              Open design tokens
        ...
        <Card>
          ...
          <CardContent className="text-xs text-muted-foreground">
            Build on top of accessible primitives and verify with automated checks.
          </CardContent>
          <CardFooter>
            <Button size="sm" variant="outline">
