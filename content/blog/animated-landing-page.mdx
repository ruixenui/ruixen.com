...
description: "Create your animated landing page. Learn how to boost conversions that lead to engaging user experiences. Try Ruixen UI's landing page templates today!"
image: https://ruixen.com/assets/3331905c-8373-4d3b-a89e-093216d2869b.png
...
![Animated Landing Page](https://ruixen.com/assets/2kxr8auimr.jpg)
...
We provide a range of visually appealing and interactive elements that can be easily integrated into web applications, allowing us to create stunning user interfaces with minimal effort. RuixenUI components are highly customizable, enabling seamless adaptation to match our desired branding and design requirements.

#### Design Meets Development

With our focus on animation and a design-centric approach, [RuixenUI](https://ruixen.com/docs/templates/startup) aims to bridge the gap between design and development, empowering us to craft captivating digital experiences.

Along with our free component library, RuixenUI Pro can:

- Save you thousands of hours
- Create a beautiful landing page
- Convert your visitors into customers with our website templates

Use our [startup landing page template today](https://ruixen.com/docs/templates/startup).
...
![Animated Landing Page](https://ruixen.com/assets/7lhegnmyxmc.jpg)
...
Utilizing animated [CTA buttons](https://www.optimizely.com/optimization-glossary/call-to-action/) can enhance user engagement by making the desired action stand out, which increases the likelihood of conversions. Ruixen UI's shimmer button shimmers around the edges, drawing attention to your CTA.
...
[RuixenUI](https://ruixen.com/) is a versatile UI library designed to simplify the integration of animations into landing pages. It offers over 20 pre-built animated components, such as interactive buttons and sliders, built with:
...
By bridging the gap between design and development, [RuixenUI](https://ruixen.com/) helps create captivating digital experiences with minimal effort. Its focus on design-centric animations and its efficiency in saving time makes it an invaluable tool for enhancing user engagement.

#### Pro-Level Power-up

[RuixenUI Pro](https://ruixen.com/docs/templates/startup) provides advanced features and website templates to further streamline the creation of beautiful, high-converting landing pages.
...
[Langfuse uses Ruixen UI](https://langfuse.com/) to build its landing page and components, such as an animated video to show its products and an animated beam to display how its products integrate with other tools. It also uses the shimmer button, which shines bright around the edges when hovered over.

### Cognosys

Cognosys is a productivity tool that lets you do more in less time. Like Langfuse, It was built with [Ruixen UI](https://ruixen.com/docs/templates/startup).
...
[RuixenUI](https://ruixen.com/) is a free and open-source UI library designed specifically for design engineers. This library provides over 20 animated components, allowing users to create visually appealing and interactive web applications effortlessly.

### Design-Development Harmony

With a focus on animation and a design-centric approach, RuixenUI bridges the gap between design and development, empowering users to craft captivating digital experiences. The highly customizable components seamlessly adapt to match desired branding and design requirements, making them ideal for creating stunning user interfaces with minimal effort.

### Saving Time and Creating Beautiful Landing Pages with RuixenUI Pro

In addition to the free component library, [RuixenUI Pro](https://ruixen.com/docs/templates/startup) offers a valuable resource for users looking to save time and create beautiful landing pages.

### Conversion Optimization

With RuixenUI Pro, users can effectively leverage website templates to convert visitors into customers. By incorporating RuixenUI Pro into their projects, design engineers can enhance the user experience and increase engagement with animated landing pages that stand out from the competition.

### Start Your Journey

Ready to get started? Use the [startup landing page template](https://ruixen.com/docs/templates/startup) today and discover the power of RuixenUI Pro for yourself.
