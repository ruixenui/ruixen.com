 ...
 * @returns JSX.Element
 */
const AnimatedGradientBackground_02: React.FC<AnimatedGradientBackgroundProps> = ({
   startingGap = 125,
   Breathing = false,
   gradientColors = [
      "#FFFFFF", // pure white at the top
      "#FFEDD5", // soft light peach
      "#FFDAB9", // peach
      "#FFB6C1", // light pink
      "#E0BBE4", // pale lavender
      "#F3E5F5", // soft lavender-pink at the bottom
    ],
    
    gradientStops = [0, 25, 50, 70, 85, 100],
   animationSpeed = 0.02,
   breathingRange = 5,
   containerStyle = {},
   topOffset = 0,
...
export default AnimatedGradientBackground_02;