...
export function GradientPreview({ gradient, onOriginChange }: GradientPreviewProps) {
  ...
  return (
    <Card className="relative h-[320px] w-full overflow-hidden py-0 border border-white/10 bg-slate-950/70 shadow-[0_18px_60px_rgba(0,0,0,0.6)] backdrop-blur-md">
      <div
        ref={ref}
        className="relative h-full w-full cursor-crosshair"
        style={{
          backgroundImage: cssValue,
          backgroundBlendMode: gradient.blendMode === "normal" ? "normal" : gradient.blendMode,
        }}
      ...
      >
        ...
        <div
          className={cn(
            "pointer-events-none absolute z-10 h-3 w-3 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/80 shadow-[0_0_0_4px_rgba(0,0,0,0.45)]",
